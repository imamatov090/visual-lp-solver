...
st.write("Визуализация и решение задачи линейного программирования (2 переменные)")
...
sign1 = st.sidebar.selectbox("Знак", ["≤", "≥", "="], key="sign1")
...
sign2 = st.sidebar.selectbox("Знак", ["≤", "≥", "="], key="sign2")
...
add_constraint(c1, d1, b1, sign1)
add_constraint(c2, d2, b2, sign2)
...
with col2:
    ...
    # Область допустимых решений (примерно)
...
st.caption("Разработано специально для визуального изучения линейного программирования.")
